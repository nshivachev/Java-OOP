...
public class CommandImpl implements CommandInterface {
    ...
    class CutTransform implements TextTransform {
        ...
        public void invokeOn(StringBuilder text, int startIndex, int endIndex) {
            ...
            if (startIndex != endIndex) {
                textToPaste.append(text.substring(startIndex, endIndex));
    ...
    class PateTransform implements TextTransform {
        @Override
        public void invokeOn(StringBuilder text, int startIndex, int endIndex) {
            if (startIndex == endIndex) {
                text.insert(startIndex, textToPaste);
            } else {
                text.replace(startIndex, endIndex, textToPaste.toString());
            }
        }
    }
    ...
    private static StringBuilder textToPaste = new StringBuilder();
    ...
    protected List<Command> initCommands() {
        ...
        commands.add(new Command("paste", new PateTransform()));
